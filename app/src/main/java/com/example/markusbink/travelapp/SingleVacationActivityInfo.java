...
public class SingleVacationActivityInfo extends ActionBarActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singlevacation_notify_version);
    ...
    private void initListeners() {
        buttonBackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SingleVacationActivityInfo.this, MainActivity.class);
                startActivity(i);
            }
